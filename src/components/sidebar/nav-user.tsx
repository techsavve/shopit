...
export function NavUser({ user }: { user: IMerchant }) {
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-semibold">{user.personal.first_name}</span>
                <span className="truncate text-xs">{user.personal.email_address}</span>
              </div>
